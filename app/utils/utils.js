...
const symbolList = [
  ...
  { symbol: 'EETH', contract: 'weosservices', digit: 4 },
  { symbol: 'FC', contract: 'fcfundissuer', digit: 4 },
  { symbol: 'LITE', contract: 'eosliteworld', digit: 4 },
  ...
  { symbol: 'CUBE', contract: 'eoscubeadmin', digit: 4 },
  ...
  { symbol: 'EOSISH', contract: 'vladimirwish', digit: 4 },
  { symbol: 'BTN', contract: 'eosbuttonbtn', digit: 4 },
  { symbol: 'DAB', contract: 'eoscafekorea', digit: 4 },
  { symbol: 'ADE', contract: 'cadeositoken', digit: 4 },
  { symbol: 'LUCK', contract: 'eosluckchain', digit: 4 },
  { symbol: 'EVR', contract: 'eosvrmanager', digit: 4 },
