...
export class IQPage extends React.Component {
  ...
  getIqRefundFormItem = () => {
      ...
      const RefundIqSearchStakeIdSuccessNull = this.state.formatMessage(
          messages.RefundIqSearchStakeIdSuccessNull,
      );
      ...
      return (
          <div>
              <FormItem style={FormItemButtonStyle}>
                  ...
                  {isSearchStakeIds ? (
                      isSearchStakeIdsSuccess ? (
                          <p>{StakeIdsForRefund.length > 0 ? RefundIqSearchStakeIdSuccess : RefundIqSearchStakeIdSuccessNull}</p>
                      ) : (
